...
const ReactPythonBackground = () => {
    return (
        <div className="reactPythonBackground">
            ...
            <svg width="600" height="600" viewbox="0 0 100 100" style={{position: "absolute", top: "8%", left: "29%"}} fill="#33EAC9" >
            ...
            <svg width="500" height="500" viewbox="0 0 100 100" style={{position: "absolute", bottom: "7%", left: "1%"}} fill="#33EAC9" >
                <circle cx="250" cy="250" r="250" />
            </svg>
        </div>
    )
