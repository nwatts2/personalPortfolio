                ...
                <div className="column contactBox">
                    <div className="column contactBoxBlock box1" onClick={() => {window.open("https://www.linkedin.com/in/noahwatts/", '_blank', 'noreferrer')}}>
                        <div className="row contactBoxEntry">
                            <div className="column contactBoxSVG">
                                <svg style={{border: "3px solid white", borderRadius: "10px"}} viewBox="0 0 256 256"><path d="M77.796 214.238V98.986H39.488v115.252H77.8zM58.65 83.253c13.356 0 21.671-8.85 21.671-19.91-.25-11.312-8.315-19.915-21.417-19.915-13.111 0-21.674 8.603-21.674 19.914 0 11.06 8.312 19.91 21.169 19.91h.248zM99 214.238h38.305v-64.355c0-3.44.25-6.889 1.262-9.346 2.768-6.885 9.071-14.012 19.656-14.012 13.858 0 19.405 10.568 19.405 26.063v61.65h38.304v-66.082c0-35.399-18.896-51.872-44.099-51.872-20.663 0-29.738 11.549-34.78 19.415h.255V98.99H99.002c.5 10.812-.003 115.252-.003 115.252z" fill="white"/></svg>
                        ...
                        <div className="row contactBoxEntry">
                            <div className="column contactBoxSVG">
                                <svg viewBox="0 0 24 24" fill="none" >
                                    <path d="M4 7L10.94 11.3375C11.5885 11.7428 12.4115 11.7428 13.06 11.3375L20 7M5 18H19C20.1046 18 21 17.1046 21 16V8C21 6.89543 20.1046 6 19 6H5C3.89543 6 3 6.89543 3 8V16C3 17.1046 3.89543 18 5 18Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                                </svg>
                                <hr />
                            </div>
                    ...
                    <div className="column contactBoxBlock box3" onClick={() => {window.open("tel:+17196843010", '_blank', 'noreferrer')}}>
                        <div className="row contactBoxEntry">
                            <div className="column contactBoxSVG">
                                <svg viewBox="0 0 24 24" fill="none">
                                    <path d="M9 2C9 1.44772 9.44772 1 10 1H14C14.5523 1 15 1.44772 15 2V3C15 3.55228 14.5523 4 14 4H10C9.44772 4 9 3.55228 9 3V2Z" fill="white"/>
                                    <rect x="5.75" y="1.75" width="12.5" height="20.5" rx="1.75" stroke="white" strokeWidth="1.5"/>
