...
const NavBar = ({ page, setPage, sizer }) => {
    const [pathShape, setPathShape] = useState(`M${15 / sizer.width * 100},98 h${280 / sizer.width * 100} q${15 / sizer.width * 100},0 ${15 / sizer.width * 100},-25 v-25 q0,-25 ${15 / sizer.width * 100},-25 h${(sizer.width > 1920 ? (747) : (sizer.width > 1800 ? (732) : (sizer.width - 1110))) / sizer.width * 100} q${15 / sizer.width * 100},0 ${15 / sizer.width * 100},25 v25 q0,25 ${15 / sizer.width * 100},25 h${95 / sizer.width * 100} q${15 / sizer.width * 100},0 ${15 / sizer.width * 100},-25 v-25 q0,-25 ${15 / sizer.width * 100},-25 h${(sizer.width > 1920 ? (sizer.width + 48) : (sizer.width > 1800 ? (sizer.width + 33) : (sizer.width))) / sizer.width * 100} l0,-26 h-${(sizer.width > 1800 ? (2 * sizer.width + 1195) : (3 * sizer.width - 595)) / sizer.width * 100} v26 h${(sizer.width > 1800 ? ((sizer.width - 95) / sizer.width * 100) : 100)} q${15 / sizer.width * 100},0 ${15 / sizer.width * 100},25 v25 q0,25 ${15 / sizer.width * 100},25 z`);
    ...
    /*const homeShape = "M0.6,98 h15.65 q0.8,0 0.8,-25 v-25 q0,-25 0.8,-25 h29.25 q0.8,0 0.8,25 v25 q0,25 0.8,25 h6.5 q0.8,0 0.8-25 v-25 q0,-25 0.8,-25 h243.5 l1,-26 h-502 v26 h199.75 q0.8,0 0.8,25 v25 q0,25 0.6,25 h0.25 z"
    const swiftShape = "M0.6,98 h15.65 q0.8,0 0.8,-25 v-25 q0,-25 0.8,-25 h45.25 q0.8,0 0.8,25 v25 q0,25 0.8,25 h6.5 q0.8,0 0.8-25 v-25 q0,-25 0.8,-25 h227.5 l1,-26 h-502 v26 h199.75 q0.8,0 0.8,25 v25 q0,25 0.6,25 h0.25 z"
    const reactShape = "M0.6,98 h15.65 q0.8,0 0.8,-25 v-25 q0,-25 0.8,-25 h53.25 q0.8,0 0.8,25 v25 q0,25 0.8,25 h6.5 q0.8,0 0.8-25 v-25 q0,-25 0.8,-25 h219.5 l1,-26 h-502 v26 h199.75 q0.8,0 0.8,25 v25 q0,25 0.6,25 h0.25 z"
    const pythonShape = "M0.6,98 h15.65 q0.8,0 0.8,-25 v-25 q0,-25 0.8,-25 h61.25 q0.8,0 0.8,25 v25 q0,25 0.8,25 h6.5 q0.8,0 0.8-25 v-25 q0,-25 0.8,-25 h211.5 l1,-26 h-502 v26 h199.75 q0.8,0 0.8,25 v25 q0,25 0.6,25 h0.25 z"
    const contactShape = "M0.6,98 h15.65 q0.8,0 0.8,-25 v-25 q0,-25 0.8,-25 h69.25 q0.8,0 0.8,25 v25 q0,25 0.8,25 h6.5 q0.8,0 0.8-25 v-25 q0,-25 0.8,-25 h203.5 l1,-26 h-502 v26 h199.75 q0.8,0 0.8,25 v25 q0,25 0.6,25 h0.25 z"
    */
